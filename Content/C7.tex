		...
		\item {\color{lblue} Interior Points and Open Sets}
			...
			\begin{itemize}[leftmargin=1cm, itemsep=0.1cm]
				\item Interior Point
					...
					\qquad The set of all interior points = E$^o$
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.28]{Images/7.1.2c.png}
			\end{figure}
		...
		\item {\color{lblue} More about Sets}
			...
			\begin{itemize}[leftmargin=1cm, itemsep=0.1cm]
				...
				\item Complement
					...
					\qquad From E, E$^c$ is the set of all p $\in$ X such that p $\not \in$ E
				...
				\item Boundary Point
					...
					\qquad For  p $\in$ X, if every N$_r(p)$ contains a
					x $\in$ E and y $\in$ E$^c$
					
					\qquad The set of all boundary points = $\partial$E \\
			\end{itemize}
	\end{enumerate}

	\qquad For a metric space X, \{X,$\emptyset$\} are both open and closed. \\
